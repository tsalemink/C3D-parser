...
class Ui_MarkerSetDialog(object):
    def setupUi(self, MarkerSetDialog):
        ...
        MarkerSetDialog.resize(280, 538)
        ...
        self.buttonBox = QDialogButtonBox(MarkerSetDialog)
        ...
        self.buttonBox.accepted.connect(MarkerSetDialog.accept)
        self.buttonBox.rejected.connect(MarkerSetDialog.reject)
